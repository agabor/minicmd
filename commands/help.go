...
func ShowHelp() {
	...
	fmt.Println()
	fmt.Println("Usage:")
	fmt.Println("  y act [prompt_content]  # Generate code with optional custom prompt content")
	fmt.Println("  y bash [script_content] # Generate a bash script file")
	fmt.Println("  y ask [question]        # Ask questions about the codebase")
	fmt.Println("  y edit                      # Edit the prompt file")
